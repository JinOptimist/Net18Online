...
namespace Everything.Data.Migrations
{
    ...
    [Migration("20250313121228_AddCartDataInDbContext")]
    partial class AddCartDataInDbContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Everything.Data.Models.CartData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Everything.Data.Models.NotificationData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Everything.Data.Models.TagGameData", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Everything.Data.Models.CartData", b =>
                {
                    b.HasOne("Everything.Data.Models.CoffeData", "Coffe")
                        .WithMany()
            ...
            modelBuilder.Entity("Everything.Data.Models.TagGameData", b =>
                {
                    b.HasOne("Everything.Data.Models.UserData", "Creator")
                        .WithOne("TagGame")
                        .HasForeignKey("Everything.Data.Models.TagGameData", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("NotificationDataUserData", b =>
                {
                    b.HasOne("Everything.Data.Models.NotificationData", null)
                        .WithMany()
