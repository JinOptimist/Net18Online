...
namespace MazeCore.Actions
{
    public class WanderingMerchantActions
    {
        ...
        public WanderingMerchantActionResult PerformAction(IBaseCharacter character, WanderingMerchantOptions option)
        {
            switch (option)
            {
        ...
        private WanderingMerchantActionResult TryBuyHealingSalve(IBaseCharacter character)
        {
