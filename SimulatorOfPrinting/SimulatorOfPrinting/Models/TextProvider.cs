...
namespace SimulatorOfPrinting.Models
{
    public class TextProvider
    {
        private readonly string[] texts = new string[]
        {
            ...
            "From artificial intelligence to virtual reality, the possibilities are endless. Embrace the change and learn new skills to stay relevant.",
            "Make time for reading in your daily routine.",
            "Each sunset is a reminder of the beauty of nature and the passage of time. Take a moment to appreciate the little things in life.",
            "Each destination has its own unique charm, from bustling cities to serene landscapes. Plan your next adventure and explore what the world has to offer."
        };
